...
import com.umuttepe.studentalumni.dto.user.TeacherAddDTO;
import com.umuttepe.studentalumni.dto.user.TeacherEditDTO;
...
public class AdminController {
    ...
    public List<UserEntity> findAll() {
        return userService.findAllUsers(UserRole.ADMIN);
    }
    ...
    public UserEntity add(@Valid @RequestBody TeacherAddDTO user) throws UserCheckException {
        ...
        UserEntity userEntity = userService.saveWithRole(convertTeacherAddToEntity(user), UserRole.ADMIN);
        return userEntity;
    }
