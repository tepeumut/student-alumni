...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleUserCheck(
            UserCheckException ex) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage("User validation error");
        apiError.addValidationErrors(ex.getFieldErrors());
        return buildResponseEntity(apiError);
    }

    @ExceptionHandler(UserNotFoundException.class)
    protected ResponseEntity<Object> handleUserNotFoundExp(
            UserCheckException ex) {
        ApiError apiError = new ApiError(UNAUTHORIZED);
        apiError.setMessage("User unauthorized");
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleSurveyNotFound(
